...
app.layout = html.Div(
	...
	html.H5('Topics : Bitcoin, Ethereum, Crypto'),
...
def update_graph_scatter(sentiment_term):
    try:
        ...
        c = conn.cursor()
        df = pd.read_sql("SELECT * FROM sentiment WHERE tweet LIKE ? ORDER BY unix DESC LIMIT 150000", conn ,params=('%' + sentiment_term + '%',))
